...
//     return local;
// }
import { basket } from './basket'; // долго тупил, почему ничего не работает, в итоге в консольке написано, что баскет андефайнд. 
                                // в итоге смотрю на код и понимаю, что баскет присваивается в this.basket но не приходит извне.
                                // надеюсь, импорт компонента это правильное решение
...
export let catalog = {
    ...
    _render() {
        ...
        this.items.forEach(item => {
            ...
            //                 </div>
            //             </div>`
            htmlStr += ` <div class="featured__items_block">
